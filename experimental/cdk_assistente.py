...
with st.sidebar:
    ...
    st.markdown("---")
    st.markdown("Conheça os serviços Individuais, Formaçõeportfólios e Programas:")

    # Link para o site da DSA
    st.markdown("🔗 [CDK TECK - Soluções Tecnológicas](https://www.cdkteck.com.br)")
    
    # Botão de link para enviar e-mail ao suporte da DSA
    st.link_button("✉️ E-mail Para o Suporte em Caso de Dúvidas", "mailto:contato@cdkteck.com.br")

# Título principal do app
st.title("CDK AI Coder")
